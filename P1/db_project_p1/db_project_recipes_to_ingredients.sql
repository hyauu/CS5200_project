...
CREATE TABLE `recipes_to_ingredients` (
  ...
  PRIMARY KEY (`id`),
  KEY `recipes_to_ingredients_to_recipes` (`recipe_id`),
  KEY `recipes_to_ingredients_to_ingredients` (`ingredient_id`),
  CONSTRAINT `recipes_to_ingredients_to_ingredients` FOREIGN KEY (`ingredient_id`) REFERENCES `ingredients` (`id`),
  CONSTRAINT `recipes_to_ingredients_to_recipes` FOREIGN KEY (`recipe_id`) REFERENCES `recipes` (`id`)
...
INSERT INTO `recipes_to_ingredients` VALUES (1,1,1,'60g'),(2,1,2,'300g'),(3,1,3,'10g'),(4,1,4,'5g');
